...
<p>Parallel middleware offer more fine-grained flow control, and are defined
like</p>
...
<p>Parallel middleware can <code>next()</code> immediately, but the final argument will be
called when all the parallel middleware have called <code>done()</code>.</p>
...
interrupted, and the error is passed to the callback.</p>
